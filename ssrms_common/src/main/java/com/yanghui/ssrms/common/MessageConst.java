package com.yanghui.ssrms.common;
...
public class MessageConst {
    ...
    public static final String DELETE_SSR_SUCCESS = "删除自习室成功";
    public static final String DELETE_SSR_FAIL = "删除自习室失败";
    public static final String ADD_SSR_SUCCESS = "添加自习室成功";
    public static final String ADD_SSR_FAIL = "添加自习室失败";
    public static final String QUERY_SSR_SUCCESS = "查询自习室成功";
    public static final String QUERY_SSR_FAIL = "查询自习室失败";
